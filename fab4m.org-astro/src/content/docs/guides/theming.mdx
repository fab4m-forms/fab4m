...
Fab4m provides three themes out of the box: `basic`, `tailwind`, and `bulma`.
...
If you want to use the bulma theme, include Bulma CSS.
See the [bulma documentation](https://bulma.io/).
