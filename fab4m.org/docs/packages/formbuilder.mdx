...
import FormPreviewExample from "@site/src/components/FormBuilder/FormPreviewExample";
import FormPreviewExampleSource from "!!raw-loader!@site/src/components/FormBuilder/FormPreviewExample";
...
The form builder works with any [serialized](/docs/guide/serializing) fab4m form, for example:
...
<Example
  source={FormComponentsExampleSource}
  example={<FormComponentsExample />}
/>
...
<Example
  source={NewComponentsExampleSource}
  example={<NewComponentsExample />}
/>
...
<Example
  source={EditComponentFormExampleSource}
  example={<EditComponentFormExample />}
/>
...
<Example source={FormPreviewExampleSource} example={<FormPreviewExample />} />
