...
import VariantSchema from '@site/src/components/Guide/variants/VariantSchema.tsx';
import VariantSchemaSource from '!!raw-loader!@site/src/components/Guide/variants/VariantSchema.tsx';
...
When you use variants, you need to provide the data you want to validate when you generate your
JSON Schema, for example:

<Example source={VariantSchemaSource} example={<VariantSchema />} />
