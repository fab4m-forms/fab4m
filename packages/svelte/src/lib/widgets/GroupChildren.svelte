<script lang="ts">
  import { componentErrors, filterComponents } from "@fab4m/fab4m";
  ...
  type GroupChildrenProps = Partial<Pick<WidgetProps<Record<string, unknown>, unknown>, "settings" | "ssr">> &
    Omit<WidgetProps<Record<string, unknown>, unknown>, "settings" | "ssr" | "onChange"> & {
      wrapperClass?: string;
