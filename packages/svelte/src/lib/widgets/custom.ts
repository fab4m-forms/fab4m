...
type CustomWidget<ValueType> = Component<WidgetProps<ValueType, CustomWidget<ValueType>>>;

type CustomMultipleWidget<ValueType> = Component<MultipleWidgetProps<ValueType, CustomMultipleWidget<ValueType>>>;
