...
export default {
  ...
  item: "text-xl font-bold mb-2 border px-4 py-2 bg-slate-100 rounded hover:bg-slate-200 flex dark:bg-slate-700 dark:text-gray-200 dark:hover:bg-slate-600",
  insetBtn:
